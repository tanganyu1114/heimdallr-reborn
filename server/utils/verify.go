...
var (
	...
	SDKLoginVerify            = Rules{"APIKey": {NotEmpty()}, "APISecret": {NotEmpty()}}
	GenerateAPIKeyVerify      = Rules{"UserID": {NotEmpty()}}
	ToggleAPIKeyVerify        = Rules{"UserID": {NotEmpty()}, "Enabled": {NotEmpty()}}
	RegenerateAPISecretVerify = Rules{"UserID": {NotEmpty()}}
)
