...
func (g *groupMiddleware) Get() httpclientv1.ClientBuilder[v1.IDOptions, modelclientv1.ResponseBody[*v1.Group]] {
	return wrapWithAuth(g.md, g.md.txp.Groups().Get())
}

func (g *groupMiddleware) List() httpclientv1.ClientBuilder[v1.ListOptions, modelclientv1.ResponseBody[*v1.GroupList]] {
