...
func (w *webServerConfigMiddleware) GetConfigTextLines() httpclientv1.ClientBuilder[metav1.WebServerOptions, modelclientv1.ResponseBody[string]] {
	return wrapWithAuth(w.md, w.md.txp.WebServerConfigs().GetConfigTextLines())
}

func (w *webServerConfigMiddleware) GetContextTextLines() httpclientv1.ClientBuilder[metav1.WebServerConfigTargetContextOptions, modelclientv1.ResponseBody[string]] {
	return wrapWithAuth(w.md, w.md.txp.WebServerConfigs().GetContextTextLines())
}

func (w *webServerConfigMiddleware) GetConfig() httpclientv1.ClientBuilder[metav1.WebServerOptions, modelclientv1.ResponseBody[*modelclientv1.WebServerConfig]] {
	return wrapWithAuth(w.md, w.md.txp.WebServerConfigs().GetConfig())
}

func (w *webServerConfigMiddleware) GetIncludedConfigs() httpclientv1.ClientBuilder[metav1.WebServerConfigTargetContextOptions, modelclientv1.ResponseBody[[]string]] {
	return wrapWithAuth(w.md, w.md.txp.WebServerConfigs().GetIncludedConfigs())
}

func (w *webServerConfigMiddleware) SearchContextPositions() httpclientv1.ClientBuilder[metav1.WebServerConfigContextPosSearchOptions, modelclientv1.ResponseBody[[]metav1.ConfigContextPos]] {
