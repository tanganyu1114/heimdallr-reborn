...
type HostService interface {
	...
	Get(idOptions *v1.IDOptions) (*v1.Host, error)
	// List retrieves a list of hosts
	List(listOptions *v1.ListOptions) (*v1.HostList, error)
}
...
// Get retrieves a host by ID
func (s *hostService) Get(idOptions *v1.IDOptions) (*v1.Host, error) {
	if idOptions == nil {
...
// List retrieves a list of hosts
func (s *hostService) List(listOptions *v1.ListOptions) (*v1.HostList, error) {
	if listOptions == nil {
