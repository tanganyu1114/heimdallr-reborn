...
type AgentInfoEndpoints interface {
	...
	Get() httpclientv1.Endpoint[httpclientv1.NilBody, modelclientv1.ResponseBody[[]v1.GroupInfo]]
}
...
type agentInfoEndpoints struct {
	...
	once        sync.Once
	getEndpoint httpclientv1.Endpoint[httpclientv1.NilBody, modelclientv1.ResponseBody[[]v1.GroupInfo]]
}

// Get returns the get agent info endpoint
func (a *agentInfoEndpoints) Get() httpclientv1.Endpoint[httpclientv1.NilBody, modelclientv1.ResponseBody[[]v1.GroupInfo]] {
	a.once.Do(func() {
