...
func Test_agentInfoEndpoints_Get(t *testing.T) {
	...
	mockClient := httpclientv1.NewMockClient[httpclientv1.NilBody, modelclientv1.ResponseBody[[]v1.GroupInfo]](ctrl)
	mockEndpoint := httpclientv1.NewEndpoint[httpclientv1.NilBody, modelclientv1.ResponseBody[[]v1.GroupInfo]](nil)
	...
	tests := []struct {
		name   string
		fields fields
		want   httpclientv1.Endpoint[httpclientv1.NilBody, modelclientv1.ResponseBody[[]v1.GroupInfo]]
	}{
		{
