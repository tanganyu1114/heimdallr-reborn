...
type WebServerStatisticsEndpoints interface {
	...
	GetProxyServiceInfo() httpclientv1.Endpoint[v1.WebServerOptions, modelclientv1.ResponseBody[[]v1.ProxyServiceInfo]]
	// ConnectivityCheckOfProxyService returns the connectivity check of proxy service endpoint
	ConnectivityCheckOfProxyService() httpclientv1.Endpoint[v1.ConnectivityCheckOfProxiedServersRequestOptions, modelclientv1.ResponseBody[v1.ProxyServiceInfo]]
	// ExportProxyServiceInfoToExcel returns the export proxy service info to excel endpoint
	ExportProxyServiceInfoToExcel() httpclientv1.Endpoint[v1.WebServerOptions, modelclientv1.ResponseBody[[]byte]]
}
...
type webServerStatisticsEndpoints struct {
	...
	getProxyServiceInfoEndpoint             httpclientv1.Endpoint[v1.WebServerOptions, modelclientv1.ResponseBody[[]v1.ProxyServiceInfo]]
	onceConnectivityCheckOfProxyService     sync.Once
	connectivityCheckOfProxyServiceEndpoint httpclientv1.Endpoint[v1.ConnectivityCheckOfProxiedServersRequestOptions, modelclientv1.ResponseBody[v1.ProxyServiceInfo]]
	onceExportProxyServiceInfoToExcel       sync.Once
	exportProxyServiceInfoToExcelEndpoint   httpclientv1.Endpoint[v1.WebServerOptions, modelclientv1.ResponseBody[[]byte]]
}

// GetProxyServiceInfo returns the get proxy service info endpoint
func (w *webServerStatisticsEndpoints) GetProxyServiceInfo() httpclientv1.Endpoint[v1.WebServerOptions, modelclientv1.ResponseBody[[]v1.ProxyServiceInfo]] {
...
// ConnectivityCheckOfProxyService returns the connectivity check of proxy service endpoint
func (w *webServerStatisticsEndpoints) ConnectivityCheckOfProxyService() httpclientv1.Endpoint[v1.ConnectivityCheckOfProxiedServersRequestOptions, modelclientv1.ResponseBody[v1.ProxyServiceInfo]] {
...
// ExportProxyServiceInfoToExcel returns the export proxy service info to excel endpoint
func (w *webServerStatisticsEndpoints) ExportProxyServiceInfoToExcel() httpclientv1.Endpoint[v1.WebServerOptions, modelclientv1.ResponseBody[[]byte]] {
