...
type HostEndpoints interface {
	...
	Get() httpclientv1.Endpoint[v1.IDOptions, modelclientv1.ResponseBody[*v1.Host]]
	// List returns the list hosts endpoint
	List() httpclientv1.Endpoint[v1.ListOptions, modelclientv1.ResponseBody[*v1.HostList]]
}
...
type hostEndpoints struct {
	...
	onceGet      sync.Once
	getEndpoint  httpclientv1.Endpoint[v1.IDOptions, modelclientv1.ResponseBody[*v1.Host]]
	onceList     sync.Once
	listEndpoint httpclientv1.Endpoint[v1.ListOptions, modelclientv1.ResponseBody[*v1.HostList]]
}

// Get returns the get host endpoint
func (h *hostEndpoints) Get() httpclientv1.Endpoint[v1.IDOptions, modelclientv1.ResponseBody[*v1.Host]] {
	h.onceGet.Do(func() {
...
// List returns the list hosts endpoint
func (h *hostEndpoints) List() httpclientv1.Endpoint[v1.ListOptions, modelclientv1.ResponseBody[*v1.HostList]] {
	h.onceList.Do(func() {
