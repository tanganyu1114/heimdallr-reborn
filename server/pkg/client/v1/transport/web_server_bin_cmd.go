...
type WebServerBinCMDTransport interface {
	...
	Exec() httpclientv1.ClientBuilder[metav1.WebServerBinCMDExecRequest, *metav1.WebServerBinCMDExecResponse]
}
...
func newWebServerBinCMDTransport(transport *transport) WebServerBinCMDTransport {
	t := &webServerBinCMDTransport{
		execClient: httpclientv1.NewClientBuilder[metav1.WebServerBinCMDExecRequest, *metav1.WebServerBinCMDExecResponse](
...
// Exec returns the exec client
func (w *webServerBinCMDTransport) Exec() httpclientv1.ClientBuilder[metav1.WebServerBinCMDExecRequest, *metav1.WebServerBinCMDExecResponse] {
	return w.execClient
}
