...
type GroupTransport interface {
	...
	Get() httpclientv1.ClientBuilder[metav1.IDOptions, *v1.Group]
	// List returns the list groups client
	List() httpclientv1.ClientBuilder[metav1.ListOptions, *v1.GroupList]
}
...
func newGroupTransport(transport *transport) GroupTransport {
	t := &groupTransport{
		getGroupClient: httpclientv1.NewClientBuilder[metav1.IDOptions, *v1.Group](
			httpclientv1.HTTPMethodGet,
			transport.baseURL+"/hmdrGroup/findHmdrGroup",
		).WithOptions(
			http_transport.SetClient(transport.Client),
		),
		listGroupsClient: httpclientv1.NewClientBuilder[metav1.ListOptions, *v1.GroupList](
			httpclientv1.HTTPMethodGet,
...
// Get returns the get group client
func (g *groupTransport) Get() httpclientv1.ClientBuilder[metav1.IDOptions, *v1.Group] {
	return g.getGroupClient
}

// List returns the list groups client
func (g *groupTransport) List() httpclientv1.ClientBuilder[metav1.ListOptions, *v1.GroupList] {
