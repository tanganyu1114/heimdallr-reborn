...
type WebServerStatisticsTransport interface {
	...
	GetProxyServiceInfo() httpclientv1.ClientBuilder[v1.WebServerOptions, modelclientv1.ResponseBody[[]v1.ProxyServiceInfo]]
	// ConnectivityCheckOfProxyService returns the connectivity check of proxy service client
	ConnectivityCheckOfProxyService() httpclientv1.ClientBuilder[v1.ConnectivityCheckOfProxiedServersRequestOptions, modelclientv1.ResponseBody[v1.ProxyServiceInfo]]
	// ExportProxyServiceInfoToExcel returns the export proxy service info to excel client
	ExportProxyServiceInfoToExcel() httpclientv1.ClientBuilder[v1.WebServerOptions, modelclientv1.ResponseBody[[]byte]]
}
...
func newWebServerStatisticsTransport(transport *transport) WebServerStatisticsTransport {
	t := &webServerStatisticsTransport{
		getProxyServiceInfoClient: httpclientv1.NewClientBuilder[v1.WebServerOptions, modelclientv1.ResponseBody[[]v1.ProxyServiceInfo]](
			httpclientv1.HTTPMethodPost,
			transport.baseURL+"/hmdr-statistics/proxy-svc-brief",
		).WithOptions(
			http_transport.SetClient(transport.Client),
		),
		connectivityCheckOfProxyServiceClient: httpclientv1.NewClientBuilder[v1.ConnectivityCheckOfProxiedServersRequestOptions, modelclientv1.ResponseBody[v1.ProxyServiceInfo]](
			httpclientv1.HTTPMethodPost,
			transport.baseURL+"/hmdr-statistics/conn-check-of-proxy-svc",
		).WithOptions(
			http_transport.SetClient(transport.Client),
		),
		exportProxyServiceInfoToExcelClient: httpclientv1.NewClientBuilder[v1.WebServerOptions, modelclientv1.ResponseBody[[]byte]](
			httpclientv1.HTTPMethodPost,
...
// GetProxyServiceInfo returns the get proxy service info client
func (w *webServerStatisticsTransport) GetProxyServiceInfo() httpclientv1.ClientBuilder[v1.WebServerOptions, modelclientv1.ResponseBody[[]v1.ProxyServiceInfo]] {
	return w.getProxyServiceInfoClient
}

// ConnectivityCheckOfProxyService returns the connectivity check of proxy service client
func (w *webServerStatisticsTransport) ConnectivityCheckOfProxyService() httpclientv1.ClientBuilder[v1.ConnectivityCheckOfProxiedServersRequestOptions, modelclientv1.ResponseBody[v1.ProxyServiceInfo]] {
	return w.connectivityCheckOfProxyServiceClient
}

// ExportProxyServiceInfoToExcel returns the export proxy service info to excel client
func (w *webServerStatisticsTransport) ExportProxyServiceInfoToExcel() httpclientv1.ClientBuilder[v1.WebServerOptions, modelclientv1.ResponseBody[[]byte]] {
