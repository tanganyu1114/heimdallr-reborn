...
type AgentInfoTransport interface {
	...
	Get() httpclientv1.ClientBuilder[httpclientv1.NilBody, []v1.GroupInfo]
}
...
func newAgentInfoTransport(transport *transport) AgentInfoTransport {
	t := &agentInfoTransport{
		getAgentInfoClient: httpclientv1.NewClientBuilder[httpclientv1.NilBody, []v1.GroupInfo](
...
// Get returns the get agent info client
func (a *agentInfoTransport) Get() httpclientv1.ClientBuilder[httpclientv1.NilBody, []v1.GroupInfo] {
